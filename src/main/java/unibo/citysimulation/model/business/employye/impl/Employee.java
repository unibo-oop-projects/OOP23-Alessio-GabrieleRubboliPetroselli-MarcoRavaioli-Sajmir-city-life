 ...
 */
public final class Employee implements EmployeeStatus {
    ...
    public final boolean isLate(final Pair<Integer, Integer> businessPosition) {
        Pair<Integer, Integer> personPosition = this.person.getPosition().get();
        if (personPosition == null || businessPosition == null) {
            return false;
            
        }
        return !personPosition.equals(businessPosition);
    }
}
